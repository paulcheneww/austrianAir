...
## Version 8 – manual seats, Business zone & document animation

- opening a passenger no longer assigns a seat automatically
- **Sitz automatisch** is now the only action that triggers automatic seat assignment
- the internal and passenger-facing seat maps start at row 1
- rows **1–4** are visually marked as the Business zone in **#2B3087**
- non-Business passengers can select a seat in rows 1–4 for a simulated **€12 surcharge**; the booked travel class does not change
- Business passengers use the **#2B3087** visual theme throughout passenger-specific display screens
- document/passport confirmation now triggers a dedicated animated document-check screen
- passenger display cache-busting updated to `passenger-display.html?v=8`
